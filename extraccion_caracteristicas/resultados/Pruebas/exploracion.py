...
# Cargar el dataset
df = pd.read_csv('./extraccion_caracteristicas/resultados/dataset_clasificacion_pecoreo.csv')
...
# Normalizar características (si no estás segura si ya están normalizadas)
